...
2. Github repository
   * สร้าง repository
3. Heroku account
   * สร้าง App และเชื่อมต่อเข้ากับ GitHub
4. เชื่อม LineBot เข้ากับ Heroku
...
1. เข้าไปที่ [https://www.heroku.com/](https://www.heroku.com/) กดปุ่ม Signup หรืกดปุ่ม SIGN UP FOR FREE  
...
หลังจากที่เราทำการเชื่อม LineBot เข้ากับ Heroku แล้ว หลังจากนี้เราแทบไม่ได้ยุ่งอะไรกับ Heroku เลย เราจะยุ่งแต่กับ Line กับ Git เท่านั้น และจากนี้ไป เราจะมาทำการเชื่อมต่อ Linebot กับ Heroku กัน

1. เข้าไปยัง Heroku และไปยังแอปที่เราสร้างไว้ มองมุมขวามือคลิกขวาที่ปุ่ม Open app แล้วเลือก Copy Link Address หรือท่านจะใช้วิธีคลิกปุ่ม Open app \(คลิกซ้าย\) เพื่อเปิดแอป แล้วก้อปปี้ URL มา
   ![](/assets/2017-10-09_1121.png)

2. เข้าไปยัง https://developers.line.me/console/ แล้วคลิกปุ่ม Configuration not yet complete ของบอทที่เราสร้างไว้
   ![](/assets/2017-10-09_1125.png)

3. เมื่อเข้าสู่หน้ารายละเอียดบอท ให้เลื่อนลงไปหา Messaging settings คลิกปุ่ม Issue เพื่อทำการสร้าง Access Token 
   ![](/assets/2017-10-09_1127.png)

4. จะมีหน้าต่าง Issue a new channel access token แสดงขึ้นมา ให้คลิกปุ่ม Issue สีเขียว
   ![](/assets/2017-10-09_1128.png)

5. คลิกเครื่องหมายดินสอหลัง Use webhooks เพื่อบอกให้ Line ทราบว่าเราต้องการใช้ Webhook 
   Webhook ตรงนี้แหละที่เป็นพระเอกตัวจริงของระบบ LineBot เพราะเมื่อมีคนส่งข้อความใดๆคุยกับ Bot ทาง Line Server จะรู้ว่าเราต้องการให้ส่งเมสเสจนั้นต่อไปยังที่อื่นหรือไม่ก็ตรงนี้

   ![](/assets/2017-10-09_1129.png)

6. เลือก Enabled แล้วคลิกปุ่ม Update
   ![](/assets/2017-10-09_1130.png)

7. คลิกปุ่มเครื่องหมายดินสอหลัง Webhook URL Requires SSL
   ![](/assets/2017-10-09_1131.png)

8. ป้อน URL ที่เราก้อปปี้มาจาก Heroku ลงไปและอย่าลืมเอา https:// ออกด้วย จากนั้นคลิกปุ่ม Update
   ![](/assets/2017-10-09_1132.png)

9. จะมีปุ่ม Veriry ปรากฎขึ้นมาให้เราคลิกปุ่ม Verify เพื่อให้ Line ตรวจสอบว่า URL ของเรานั้นถูกต้องหรือไม่
   ![](/assets/2017-10-09_1133.png)

10. ถ้ามีเครื่องหมายถูกสีเขียวแสดงขึ้น หมายความว่าทุกอย่างเรียบร้อย แต่ถ้าขึ้นเรื่องหมายตกใจสีแดงๆ แสดงว่ามีบางอย่างผิดพลาด ให้กลับไปตรวจดู URL เราอีกครั้ง
    ![](/assets/2017-10-09_1134.png)

กระบวนการการเตรียมความพร้อมเสร็จลงแล้ว หลังจากนี้ไปเหลือแต่การเขียนโค้ดแล้ว ได้เวลามือเปื้อน
